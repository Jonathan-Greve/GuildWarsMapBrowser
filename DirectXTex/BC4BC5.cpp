...
//------------------------------------------------------------------------------
void FindEndPointsBC4U(_In_reads_(BLOCK_SIZE) const float theTexelsU[], _Out_ uint8_t& endpointU_0,
...
void FindEndPointsBC4S(_In_reads_(BLOCK_SIZE) const float theTexelsU[], _Out_ int8_t& endpointU_0,
...
inline void FindEndPointsBC5U(_In_reads_(BLOCK_SIZE) const float theTexelsU[],
                              _In_reads_(BLOCK_SIZE) const float theTexelsV[], _Out_ uint8_t& endpointU_0,
                              _Out_ uint8_t& endpointU_1, _Out_ uint8_t& endpointV_0,
...
inline void FindEndPointsBC5S(_In_reads_(BLOCK_SIZE) const float theTexelsU[],
                              _In_reads_(BLOCK_SIZE) const float theTexelsV[], _Out_ int8_t& endpointU_0,
                              _Out_ int8_t& endpointU_1, _Out_ int8_t& endpointV_0,
...
//------------------------------------------------------------------------------
void FindClosestUNORM(_Inout_ BC4_UNORM* pBC,
...
void FindClosestSNORM(_Inout_ BC4_SNORM* pBC,
                      _In_reads_(NUM_PIXELS_PER_BLOCK) const float theTexelsU[]) noexcept
{
    float rGradient[8];
    for (size_t i = 0; i < 8; ++i)
...
_Use_decl_annotations_ void DirectX::D3DXEncodeBC4U(uint8_t* pBC, const XMVECTOR* pColor,
...
_Use_decl_annotations_ void DirectX::D3DXEncodeBC4S(uint8_t* pBC, const XMVECTOR* pColor,
                                                    uint32_t flags) noexcept
{
    UNREFERENCED_PARAMETER(flags);
...
_Use_decl_annotations_ void DirectX::D3DXEncodeBC5U(uint8_t* pBC, const XMVECTOR* pColor,
                                                    uint32_t flags) noexcept
{
    UNREFERENCED_PARAMETER(flags);
...
_Use_decl_annotations_ void DirectX::D3DXEncodeBC5S(uint8_t* pBC, const XMVECTOR* pColor,
                                                    uint32_t flags) noexcept
{
    UNREFERENCED_PARAMETER(flags);
