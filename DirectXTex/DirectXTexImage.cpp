...
_Use_decl_annotations_ HRESULT DirectX::Internal::DetermineImageArray(const TexMetadata& metadata,
                                                                      CP_FLAGS cpFlags, size_t& nImages,
...
_Use_decl_annotations_ HRESULT ScratchImage::Initialize1D(DXGI_FORMAT fmt, size_t length, size_t arraySize,
                                                          size_t mipLevels, CP_FLAGS flags) noexcept
{
    if (! length || ! arraySize)
        return E_INVALIDARG;
...
_Use_decl_annotations_ HRESULT ScratchImage::Initialize2D(DXGI_FORMAT fmt, size_t width, size_t height,
                                                          size_t arraySize, size_t mipLevels,
...
_Use_decl_annotations_ HRESULT ScratchImage::Initialize3D(DXGI_FORMAT fmt, size_t width, size_t height,
                                                          size_t depth, size_t mipLevels,
                                                          CP_FLAGS flags) noexcept
{
...
_Use_decl_annotations_ HRESULT ScratchImage::InitializeCube(DXGI_FORMAT fmt, size_t width, size_t height,
                                                            size_t nCubes, size_t mipLevels,
                                                            CP_FLAGS flags) noexcept
{
...
_Use_decl_annotations_ HRESULT ScratchImage::InitializeFromImage(const Image& srcImage, bool allow1D,
                                                                 CP_FLAGS flags) noexcept
{
...
_Use_decl_annotations_ HRESULT ScratchImage::InitializeArrayFromImages(const Image* images, size_t nImages,
                                                                       bool allow1D, CP_FLAGS flags) noexcept
{
    if (! images || ! nImages)
        return E_INVALIDARG;
...
_Use_decl_annotations_ HRESULT ScratchImage::InitializeCubeFromImages(const Image* images, size_t nImages,
                                                                      CP_FLAGS flags) noexcept
{
    if (! images || ! nImages)
        return E_INVALIDARG;
...
_Use_decl_annotations_ HRESULT ScratchImage::Initialize3DFromImages(const Image* images, size_t depth,
                                                                    CP_FLAGS flags) noexcept
{
    if (! images || ! depth)
        return E_INVALIDARG;
...
_Use_decl_annotations_ const Image* ScratchImage::GetImage(size_t mip, size_t item,
