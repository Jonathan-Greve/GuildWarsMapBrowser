...
#include <DirectXMath.h>
    ...
    Mesh GenerateTerrainMesh()
    {
        ...
        m_terrain_shadow_map_grid.resize(m_grid_dim_z + 1, std::vector<uint32_t>(m_grid_dim_x + 1, 0.0f));
        ...
        return Mesh(vertices, indices, {0}, {0}, {0}, true, BlendState::Opaque, 1, {10000000, 10000000, 10000000});
    }
