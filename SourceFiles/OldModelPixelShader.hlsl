...
PSOutput main(PixelInputType input)
{
    ...
    // Apply textures
    float4 sampledTexture_Type0 = float4(1, 1, 1, 1);
    float4 sampledTexture_Type10 = float4(1, 1, 1, 1);
    float4 sampledTexture_Type512 = float4(1, 1, 1, 1);
    float4 sampledTexture_Type1024 = float4(1, 1, 1, 1);
    float4 sampledTexture_Type1536 = float4(1, 1, 1, 1);
    float4 sampledTexture_Type1546 = float4(1, 1, 1, 1);
    float4 sampledTexture_Type2050 = float4(1, 1, 1, 1);
    float4 sampledTexture_Type2434 = float4(1, 1, 1, 1);
    float4 sampledTexture_Type4482 = float4(1, 1, 1, 1);
    float4 sampledTexture_Type4490 = float4(1, 1, 1, 1);
    float4 sampledTexture_Type17920 = float4(1, 1, 1, 1);
    float4 sampledTexture_Type17930 = float4(1, 1, 1, 1);
