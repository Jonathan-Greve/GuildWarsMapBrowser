...
private:
    Mesh GenerateBoxMesh(const DirectX::XMFLOAT3& size)
    {
        ...
        std::vector<Vertex> vertices = {
          // Front face
          {topLeftFront, frontNormal, tex11},
          {bottomLeftFront, frontNormal, tex01},
          {bottomRightFront, frontNormal, tex00},
          {topRightFront, frontNormal, tex10},
          // Back face
          {topRightBack, backNormal, tex11},
          {bottomRightBack, backNormal, tex01},
          {bottomLeftBack, backNormal, tex00},
          {topLeftBack, backNormal, tex10},
          // Left face
          {topLeftBack, leftNormal, tex11},
          {bottomLeftBack, leftNormal, tex01},
          {bottomLeftFront, leftNormal, tex00},
          {topLeftFront, leftNormal, tex10},
          // Right face
          {topRightFront, rightNormal, tex11},
          {bottomRightFront, rightNormal, tex01},
          {bottomRightBack, rightNormal, tex00},
          {topRightBack, rightNormal, tex10},
          // Top face
          {topLeftBack, topNormal, tex11},
          {topLeftFront, topNormal, tex01},
          {topRightFront, topNormal, tex00},
          {topRightBack, topNormal, tex10},
          // Bottom face
          {bottomLeftFront, bottomNormal, tex11},
          {bottomLeftBack, bottomNormal, tex01},
          {bottomRightBack, bottomNormal, tex00},
          {bottomRightFront, bottomNormal, tex10},
        };
